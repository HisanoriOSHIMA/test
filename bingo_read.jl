...
#=
    ...
    Nvec = Vector(3:2:37)
    info = zeros(Float64, length(Nvec), 5)
    ...
    #Plots.savefig("/Users/ooshimahisanori/Desktop/free_study/bingo/BINGO"*"_sample"*string(Nsample)*"_"*free*"_3.png")
end
...
function ratio(quant1, quant2, free, Nsample, Nvec)
    ...
    #Plots.savefig("/Users/ooshimahisanori/Desktop/free_study/bingo/BINGO"*"_sample"*string(Nsample)*"_"*free*"_"*quant1*quant2*".png")
